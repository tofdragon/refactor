 ...
 * @author sunjing
 */
public class OnePairCompareStrategy extends AbstractCompareStrategy {
    ...
    public String compare(String player1, String player2) {
        ...
        return sameOnePair(player1Number, player2Number);
    }

    private String sameOnePair(int[] player1Number, int[] player2Number) {
